<section class="benevolat big-section wow animate__fadeIn <?= $couleurdefondformcollecte ?>">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-10 col-md-12 text-center margin-six-bottom">
                <h3 class="alt-font text-black font-weight-500">Formulaire pour organiser<br/>une collecte de fonds</h3>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-12">
<!--                 <form id="project-contact-form" action="email-templates/contact-form.php" method="post" novalidate="">
                ...
                <?php echo do_shortcode('[contact-form-7 id="554" title="Formulaire bénévolat" html_id="project-contact-form"]') ?>
            </div>
        </div>
    </div>
</section>