<section class="big-section bg-light-gray position-relative">
    <div class="container">
                          ...
                          if( have_rows('content_blocks') ): 
                            ...
                            <div class="swiper-slide interactive-banners-style-07 border-radius-6px overflow-hidden">
                                <div class="interactive-banners-box" style=" padding:0px 0px;">
                                    <div class="interactive-banners-box-image" style="background-image:url('<?php the_sub_field('image_defilantedeux'); ?>'); width:100%; height:600px;  background-repeat:no-repeat; background-size:cover; ">
