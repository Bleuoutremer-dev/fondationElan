<section class="CTA big-section parallax wow animate__fadeIn" data-parallax-background-ratio="0.1" style="background-image:url('<?= $image_CTA ?>');">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-7 col-lg-9 col-md-11 position-relative text-center wow animate__zoomIn" data-wow-delay="0.4s">
                ...
                <a href="<?= $llien_savoir_plus_cta ?>" target="<?= $optionongletsavoirpluscta ?>" class="btn-rond"><span><strong><?= $texte_boutonCTA ?></strong></span></a>
            </div>
        </div>
    </div>
</section>