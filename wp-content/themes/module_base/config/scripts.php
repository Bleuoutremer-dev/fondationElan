...
return [
		...
		'retina' => [
		'src' => get_stylesheet_directory_uri().'/assets/scripts/retina.min.js',
		'deps' => ['jquery'],
		'ver' => '',
		'in_footer' => true,
		],
		...
		// 'src' => get_stylesheet_directory_uri().'/assets/scripts/bootstrap.bundle.min.js.map',
		// 'deps' => ['jquery'],
		// 'ver' => '',
		// 'in_footer' => true,
		// ],
		...
		// 'swiper-bundle' => [
		// 'src' => get_stylesheet_directory_uri().'/assets/scripts/swiper-bundle.min.js.map',
		// 'deps' => ['jquery'],
		// 'ver' => '',
		// 'in_footer' => true,
		// ],
