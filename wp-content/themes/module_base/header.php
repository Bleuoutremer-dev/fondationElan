...
<body data-mobile-nav-style="classic" class=" <?php body_class() ?>  id="<?php echo sanitize_title_with_dashes(get_the_title(get_the_ID())); ?>">
    ...
    <div class="col-auto col-sm-6 col-lg-2 me-auto ps-lg-0">
        <a class="navbar-brand" href="index.html">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/logo.png" data-at2x="<?php echo get_stylesheet_directory_uri() ?>/assets/images/logo.png" class="default-logo" class="default-logo" alt="">
            <img src="i<?php echo get_stylesheet_directory_uri() ?>/assets/images/logo.png" data-at2x="<?php echo get_stylesheet_directory_uri() ?>/assets/images/logo.png" class="alt-logo" alt="">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/logo.png" data-at2x="<?php echo get_stylesheet_directory_uri() ?>/assets/images/logo.png" class="mobile-logo" alt="">
        </a>
    </div>
          ...
          <div class="hamburger-menu hamburger-menu-half bg-white lg-w-60 md-w-60 sm-w-100">
                ...
                <div class="d-flex flex-column align-items-center justify-content-center h-100 padding-6-rem-all md-padding-2-rem-lr xs-no-padding-lr">
                    <a href="index.html" class="d-none d-lg-inline-block"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/push-menu-logo.png" alt="" class="md-w-160px" /></a>
