...
(function($) {
  ...
  $(document).ready(function() {
    $('#plugin-compatibility').change(function(e) {
      ...
      $(this).parent().append('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
    ...
    $('.slider').slider({
      ...
      change: function(event, ui) {
        $('.amount').after('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
    ...
    function establish_remote_connection_from_saved_profile() {
      ...
      $('.connection-status').append('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
        '" alt="" class="ajax-spinner general-spinner" />');
    ...
    $('.migrate-db-button').click(function(event) {
      ...
      $('.progress-title').after('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
    ...
    $('.save-settings-button').click(function(event) {
      ...
      $('.save-settings-button').after('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
    ...
    $('.reset-api-key').click(function() {
      ...
      $('.reset-api-key').after('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
    ...
    $('.plugin-compatibility-save').click(function() {
      ...
      $(this).after('<img src="<?php echo get_stylesheet_directory_uri()?>/' + spinner_url +
