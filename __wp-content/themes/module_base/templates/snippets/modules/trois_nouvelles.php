     ...
     <section class="big-section actualites bg-light-gray padding-nine-lr pt-100 xl-no-padding-lr">
         <div class="container">
            <h2 class="grostextevert alt-font text-left" style="color:#50D9C2;">Actualités<span style="position: relative; bottom: -5px; margin-left: 20px;color:#919191; font-size:24px; letter-spacing:3px; font-weight:600px;"><sup><strong>EN BREF</strong></sup></span></h2>
             <div class="row">
